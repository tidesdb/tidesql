...
def build_edition_html(manual: dict, args, version: str | None) -> str:
    ...
    TideSQL builds against MySQL as well, from its own repository. Saying so on
    its own page keeps a reader from applying MariaDB instructions to a build
    this manual never describes."""
...
def main() -> int:
    ...
    ap.add_argument("--host", default="MariaDB", help="the SQL server this edition targets (default: MariaDB)")
    ap.add_argument("--host-versions", default="11, 12 and 13",
                    help="the host releases this TideSQL release supports (default: 11, 12 and 13)")
